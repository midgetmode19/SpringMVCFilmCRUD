	...
	<button type="submit" class="btn btn-primary btn-sm" value="Submit">Update this film?</button>
			...
			<form action="editFilm.do" method="POST">
				...
				Release Year<br> <input type="text" name="releaseYear" /> <select
					...
					type="text" name="replacementCost" /> <br> Rating(G, PG,
				PG-13, R, NC-17)<br> <input type="text" name="rating" /><br>
				<br> Special Features<br> <select class="custom-select"
			...
			<form action="removeFilm.do" method="POST">
				Delete the film:<input type="text" name="filmId" value="${film.id}">
